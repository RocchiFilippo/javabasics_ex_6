...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("The square of " + value + " is " + valueSquareRoot);
    }
    ...
    private static void exercise4Bonus() {
        ...
        // Math.round() = round up if the value after the comma is >= 5, else round down
        System.out.println(ourValue + " after using round=" + Math.round(ourValue));
        // Math.pow() = raise the first value by the second value
